...
exports.externalDefinitions = exports.clearGlobalStore = exports.ota = exports.setLogger = exports.getConfigureKey = exports.fromZigbee = exports.toZigbee = exports.Fan = exports.Cover = exports.Lock = exports.Switch = exports.Climate = exports.Light = exports.List = exports.Composite = exports.Text = exports.Enum = exports.Binary = exports.Numeric = exports.access = exports.ACTIONS = void 0;
...
var actions_1 = require("./converters/actions");
...
function processExtensions(definition) {
    if ("extend" in definition) {
        ...
        let { extend, toZigbee, fromZigbee, exposes: definitionExposes, meta, endpoint, ota, configure: definitionConfigure, onEvent: definitionOnEvent, options, ...definitionWithoutExtend } = definition;
...
function postProcessConvertedFromZigbeeMessage(definition, payload, options, device) {
