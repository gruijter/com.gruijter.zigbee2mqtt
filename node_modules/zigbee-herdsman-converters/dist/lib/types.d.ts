...
import type { ClusterCommandKeys, ClusterCommandResponseKeys, ClusterOrRawAttributeKeys, TCustomCluster, TCustomClusterPayload } from "zigbee-herdsman/dist/controller/tstype";
...
export declare namespace Tuya {
    ...
    interface ValueConverterSingle {
        ...
        from?: (value: any, meta?: Fz.Meta, options?: KeyValue, publish?: Publish, msg?: Fz.Message<any>) => number | string | boolean | KeyValue | null;
    }
...
export declare namespace Ota {
    ...
    type CustomParseLogic = undefined | "telinkEncrypted";
    interface Settings {
        dataDir: string;
