...
const fromZigbee = {
    ...
    blitzwolf_occupancy_with_timeout: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            const newMsg = { ...msg, type: "attributeReport", data: { occupancy: dpValue.dp === dataPoints.occupancy ? 1 : 0 } };
            return fromZigbee_1.occupancy_with_timeout.convert(model, newMsg, publish, options, meta);
        },
    },
    moes_thermostat: {
        cluster: "manuSpecificTuya",
