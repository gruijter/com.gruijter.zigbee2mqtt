    ...
    const toZigbee = [
        {
            ...
            convertSet: access & exposes_1.access.SET
                ? async (entity, key, value, meta) => {
                    ...
                    await (0, utils_1.determineEndpoint)(entity, meta, cluster).write(cluster, payload, zigbeeCommandOptions);
    ...
    const toZigbee = [
        {
            ...
            convertSet: access & exposes_1.access.SET
                ? async (entity, key, value, meta) => {
                    ...
                    await (0, utils_1.determineEndpoint)(entity, meta, cluster).command(cluster, state, {}, zigbeeCommandOptions);
                    await (0, utils_1.determineEndpoint)(entity, meta, cluster).read(cluster, [attributeKey], zigbeeCommandOptions);
                    return { state: { [key]: value } };
                }
                : undefined,
