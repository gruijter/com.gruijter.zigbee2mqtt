        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                ...
                case "night_switching":
                    await entity.write("hvacThermostat", { 1041: { value: utils.getFromLookup(value, { OFF: 0, ON: 1 }), type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN } });
                    break;
                case "frost_guard":
                    ...
                    break;
                case "max_floor_temp":
                    await entity.write("hvacThermostat", { 1044: { value: value, type: zigbee_herdsman_1.Zcl.DataType.UINT8 } });
                    break;
                ...
                case "max_floor_guard":
                    await entity.write("hvacThermostat", { 1059: { value: utils.getFromLookup(value, { OFF: 0, ON: 1 }), type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN } });
                    break;
                case "weekly_timer":
                ...
                case "exteral_sensor_source":
                    await entity.write("hvacThermostat", { 1064: { value: value, type: zigbee_herdsman_1.Zcl.DataType.UINT16 } });
                    break;
                default: // Unknown key
