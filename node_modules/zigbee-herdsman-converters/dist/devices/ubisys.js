    ...
    tz: {
        ...
        configure_device_setup: {
            ...
            convertSet: async (entity, key, value, meta) => {
                ...
                if (!meta.device.softwareBuildID ||
                    !(0, semver_1.valid)(meta.device.softwareBuildID, true) ||
                    !(0, semver_1.gte)(meta.device.softwareBuildID, "1.9.0", true)) {
                    logger_1.logger.warning(`ubisys: update firmware of '${meta.options.friendly_name}' before writing configure_device_setup!`, NS);
                    return;
                }
                ...
                if (value.input_action_templates != null) {
                    ...
                    for (const template of templates) {
                        ...
                        logger_1.logger.warning(`ubisys: Using input ${input} and endpoint ${endpoint} for '${template.type}'.`, NS);
                        input += 1;
                        endpoint += 1;
                    }
                    ...
                    await devMgmtEp.writeStructured("manuSpecificUbisysDeviceSetup", [
                        {
                            attrId: attributeInputActions.ID,
                            selector: { indicatorType: zigbee_herdsman_1.Zcl.StructuredIndicatorType.Whole, indexes: [0] },
                    ...
                    for (const inputAction of resultingInputActions) {
                        await devMgmtEp.writeStructured("manuSpecificUbisysDeviceSetup", inputAction.map((a) => ({
                            attrId: attributeInputActions.ID,
                            selector: { indicatorType: zigbee_herdsman_1.Zcl.StructuredIndicatorType.Whole, indexes: [index++] },
                            dataType: zigbee_herdsman_1.Zcl.DataType.OCTET_STR,
...
exports.definitions = [
    {
        ...
        extend: [
            ...
            ubisys_1.ubisysModernExtend.pollCurrentSummDelivered(3),
    ...
    },
    {
        ...
        extend: [
            ...
            ubisys_1.ubisysModernExtend.pollCurrentSummDelivered((device) => (device.hardwareVersion < 16 ? 4 : 1)),
            ubisys_1.ubisysModernExtend.addCustomClusterManuSpecificUbisysDeviceSetup(),
        ],
        configure: async (device, coordinatorEndpoint) => {
    ...
    },
    {
        ...
        extend: [ubisys_1.ubisysModernExtend.addCustomClusterManuSpecificUbisysDeviceSetup(), ubisys_1.ubisysModernExtend.pollCurrentSummDelivered(5)],
        configure: async (device, coordinatorEndpoint) => {
    ...
    },
    {
        ...
        extend: [
            ...
            ubisys_1.ubisysModernExtend.pollCurrentSummDelivered(4),
        ],
        configure: async (device, coordinatorEndpoint) => {
    ...
    },
    {
        ...
        extend: [
            ubisys_1.ubisysModernExtend.addCustomClusterManuSpecificUbisysDeviceSetup(),
            ubisys_1.ubisysModernExtend.addCustomClusterClosuresWindowCovering(),
            ubisys_1.ubisysModernExtend.pollCurrentSummDelivered(3),
        ],
        configure: async (device, coordinatorEndpoint) => {
