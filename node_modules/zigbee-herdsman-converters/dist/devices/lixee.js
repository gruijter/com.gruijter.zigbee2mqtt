            ...
            const onEvent = (event) => {
                if (event.type === "start") {
                    event.data.device
                        ...
                        logger_1.logger.warning(`Failed to read Zigbee attributes during startup: ${e}`, NS);
                    });
                }
            };
            return { onEvent: [onEvent], isModernExtend: true };
        },
        addCustomClusterManuSpecificLixee: () => m.deviceAddCustomCluster("liXeePrivate", {
            ID: 0xff66,
            manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.NXP_SEMICONDUCTORS,
            attributes: {
                currentTarif: { ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
                tomorrowColor: { ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
                scheduleHPHC: { ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                presencePotential: { ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                startNoticeEJP: { ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                warnDPS: { ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                warnDIR1: { ID: 0x0006, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                warnDIR2: { ID: 0x0007, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                warnDIR3: { ID: 0x0008, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                motDEtat: { ID: 0x0009, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
                currentPrice: { ID: 0x0200, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
                currentIndexTarif: { ID: 0x0201, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                currentDate: { ID: 0x0202, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
                activeEnergyOutD01: { ID: 0x0203, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
                activeEnergyOutD02: { ID: 0x0204, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
                activeEnergyOutD03: { ID: 0x0205, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
                activeEnergyOutD04: { ID: 0x0206, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
                injectedVA: { ID: 0x0207, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                injectedVAMaxN: { ID: 0x0208, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                injectedVAMaxN1: { ID: 0x0209, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                injectedActiveLoadN: { ID: 0x0210, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                injectedActiveLoadN1: { ID: 0x0211, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                drawnVAMaxN1: { ID: 0x0212, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                drawnVAMaxN1P2: { ID: 0x0213, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                drawnVAMaxN1P3: { ID: 0x0214, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                message1: { ID: 0x0215, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
                message2: { ID: 0x0216, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
                statusRegister: { ID: 0x0217, type: zigbee_herdsman_1.Zcl.DataType.OCTET_STR },
                startMobilePoint1: { ID: 0x0218, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                stopMobilePoint1: { ID: 0x0219, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                startMobilePoint2: { ID: 0x0220, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                stopMobilePoint2: { ID: 0x0221, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                startMobilePoint3: { ID: 0x0222, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                stopMobilePoint3: { ID: 0x0223, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                relais: { ID: 0x0224, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                daysNumberCurrentCalendar: { ID: 0x0225, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                daysNumberNextCalendar: { ID: 0x0226, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                daysProfileCurrentCalendar: { ID: 0x0227, type: zigbee_herdsman_1.Zcl.DataType.LONG_OCTET_STR },
                daysProfileNextCalendar: { ID: 0x0228, type: zigbee_herdsman_1.Zcl.DataType.LONG_OCTET_STR },
                linkyMode: { ID: 0x0300, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            },
            commands: {},
            commandsResponse: {},
        }),
                ...
                if (val != null) {
                    ...
                    switch (at) {
                        ...
                        case "activeEnergyOutD04":
                            val = utils.precisionRound(Number.parseInt(val, 10) / 1000, kWhP); // from Wh to kWh
                            break;
                        case "relais": {
                            ...
                            for (let i = 0; i < 8; i++) {
                                relais_breakout[at_snake + (i + 1)] = (Number.parseInt(val, 10) & (1 << i)) >>> i;
                            }
...
function getCurrentConfig(device, options) {
    ...
    function getConfig(targetOption, bitLinkyMode, valueTrue, valueFalse) {
        ...
        try {
            ...
            logger_1.logger.warning(`Was not able to detect the Linky's ${targetOption}. Defaulting to ${valueDefault}. Error: ${error}`, NS);
    ...
    logger_1.logger.debug(`zlinky config: mode=${linkyMode}, phases=${linkyPhase}, production=${linkyProduction}, tariff=${currentTarf}`, NS);
    switch (currentTarf) {
...
exports.definitions = [
    {
        ...
        options: [
            ...
            e
                ...
                .withDescription("Overrides the automatic current tarif. This option will exclude unnecessary attributes. Open an issue to support more of them. Default: auto"),
            exposes.options
                .precision("kWh")
            ...
            e
                ...
                .withValueMin(1)
                .withDescription("Number of attributes requested from the ZLinky in each poll to reduce Zigbee network load. " +
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.read("liXeePrivate", ["linkyMode", "currentTarif"], { manufacturerCode: null }).catch((e) => {
                // https://github.com/Koenkk/zigbee2mqtt/issues/11674
                logger_1.logger.warning(`Failed to read Zigbee attributes during configure: ${e}`, NS);
            });
            const configReportings = [];
            const subscribeNew = getCurrentConfig(device, {}).filter((e) => e.reportable);
            const unsubscribe = endpoint.configuredReportings.filter((e) => !subscribeNew.some((r) => e.cluster.name === r.cluster && e.attribute.name === r.att));
            // Unsubscribe reports that doesn't correspond with the current config
            (await Promise.allSettled(unsubscribe.map((e) => endpoint.configureReporting(e.cluster.name, reporting.payload(
            // @ts-expect-error dynamic, expected correct since already applied
            e.attribute.name, e.minimumReportInterval, 65535, e.reportableChange), { manufacturerCode: null }))))
            ...
            for (const e of subscribeNew) {
                ...
                configReportings.push(endpoint.configureReporting(e.cluster, reporting.payload(
                // @ts-expect-error dynamic, expected correct since already applied
                params.att, params.min, params.max, params.change), {
        ...
        extend: [
            ...
            m.poll({
                ...
                option: exposes.options
                    ...
                    .withDescription("Some attributes do not support reporting and are polled instead. " +
                ...
                poll: async (device, options) => {
                    ...
                    for (const key in clustersDef) {
                        if (Object.hasOwn(clustersDef, key)) {
                            ...
                            if (targ.length) {
                                logger_1.logger.debug(`Poll: trying to read from ${cluster}: ${targ}`, NS);
                                let i;
                                let j;
                                ...
                                for (i = 0, j = targ.length; i < j; i += measurement_poll_chunk) {
                                    await endpoint.read(cluster, targ.slice(i, i + measurement_poll_chunk), { manufacturerCode: null }).catch((e) => {
                                        // https://github.com/Koenkk/zigbee2mqtt/issues/11674
                                        logger_1.logger.warning(`Failed to read Zigbee attributes during poll. If you see many of these messages, try reducing 'Measurement poll chunk'. ${e}`, NS);
                                    });
                                }
                            }
                        }
