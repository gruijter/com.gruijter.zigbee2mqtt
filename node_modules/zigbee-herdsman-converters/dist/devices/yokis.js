        ...
        const toZigbee = [
            {
                ...
                convertSet: async (entity, key, value, meta) => {
                    yokisExtendChecks.log(key, value);
                    await entity.command("manuSpecificYokisInput", "sendPress", {});
                },
            },
        ];
        return {
        ...
        const toZigbee = [
            {
                ...
                convertSet: async (entity, key, value, meta) => {
                    yokisExtendChecks.log(key, value);
                    await entity.command("manuSpecificYokisInput", "sendRelease", {});
                },
            },
        ];
        return {
        ...
        const toZigbee = [
            {
                ...
                convertSet: async (entity, key, value, meta) => {
                    ...
                    yokisExtendChecks.log(key, value);
                    await entity.command("manuSpecificYokisInput", "selectInputMode", commandWrapper.payload);
                },
            },
        ];
        return {
