...
exports.definitions = [
    ...
    },
    {
        ...
        extend: [
            (0, ikea_1.addCustomClusterManuSpecificIkeaSmartPlug)(),
            (0, ikea_1.addCustomClusterManuSpecificIkeaUnknown)(),
            m.onOff(),
            ikea_1.ikeaModernExtend.smartPlugChildLock(),
            ikea_1.ikeaModernExtend.smartPlugLedEnable(),
            m.identify(),
        ],
        ota: true,
    },
    ...
    },
    {
        ...
        extend: [
            ...
            (0, ikea_1.ikeaArrowClick)({ bind: false }),
            (0, ikea_1.ikeaBattery)(),
        ],
        ota: true,
    },
