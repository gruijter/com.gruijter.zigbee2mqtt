...
function parseZosungIRBytes(msg) {
    const m = msg;
    if (m.type === "raw" &&
        m.data &&
...
exports.definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.configureReporting("hvacThermostat", [
                {
                    attribute: { ID: 0x1004, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
                    minimumReportInterval: 0,
                    maximumReportInterval: constants.repInterval.HOUR,
                    reportableChange: null,
                },
            ...
            await endpoint.configureReporting("hvacThermostat", [
                {
                    attribute: { ID: 0x1009, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
                    minimumReportInterval: 0,
                    maximumReportInterval: constants.repInterval.HOUR,
                    reportableChange: null,
                },
            ...
            await endpoint.configureReporting("hvacThermostat", [
                {
                    attribute: { ID: 0x100b, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
                    minimumReportInterval: 0,
                    maximumReportInterval: constants.repInterval.HOUR,
                    reportableChange: null,
                },
