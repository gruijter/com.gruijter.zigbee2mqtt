    ...
    },
    {
        ...
        exposes: [
            ...
            e
                ...
                .withDescription("Climate control (HVAC Mode & Target Temperature): Use when thermostat_mode is ON. Configure min/max temperature range in device-specific Settings."),
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            // biome-ignore lint/suspicious/noExplicitAny: ignored using `--suppress`
            const meta = { device, state: device.meta.state, logger: logger_1.logger };
            try {
                // biome-ignore lint/suspicious/noExplicitAny: ignored using `--suppress`
                await lumi.toZigbee.w100_mode.convertSet(endpoint, "thermostat_mode", "OFF", meta);
            }
            catch (_error) {
                // ignore
            }
    ...
    },
    {
        ...
        extend: [
            ...
            m.enumLookup({
                ...
                cluster: "manuSpecificLumi",
                attribute: { ID: 0x0199, type: zigbee_herdsman_1.Zcl.DataType.UINT8 }, // Attribute: 409
            ...
            m.numeric({
                ...
                unit: "sec",
                cluster: "manuSpecificLumi",
                attribute: { ID: 0x014f, type: zigbee_herdsman_1.Zcl.DataType.UINT16 }, // Attribute: 335
