    ...
    },
    {
        ...
        extend: [
            m.deviceAddCustomCluster("3rWaterSensorcluster", {
                ...
                manufacturerCode: 0x1233,
                attributes: {
                    sirenOnOff: { ID: 0x0010, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    sirenMinutes: { ID: 0x0011, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                },
                commands: {},
                commandsResponse: {},
            }),
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("3rPlugGen1SpecialCluster", {
                ...
                attributes: {
                    onToOffDelay: { ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    offToOnDelay: { ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    allowBind: { ID: 0x0020, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                },
                commands: {},
                commandsResponse: {},
            }),
    ...
    },
    {
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("3rSmartBlindGen2SpecialCluster", {
                ...
                manufacturerCode: 0x1233,
                attributes: {
                    infraredEnable: { ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    compensationSpeed: { ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.INT8 },
                    limitPosition: { ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    totalCycleTimes: { ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    lastRemainingBatteryPercentage: { ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                },
                commands: {},
                commandsResponse: {},
            }),
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("3rPlugSpecialcluster", {
                ...
                attributes: {
                    ...
                    offToOnDelay: { ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    allowBind: { ID: 0x0020, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    powerUpValue: { ID: 0x0040, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    powerDownValue: { ID: 0x0041, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                },
                commands: {},
                commandsResponse: {},
            }),
