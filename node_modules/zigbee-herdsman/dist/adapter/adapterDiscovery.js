...
function findUsbAdapterBestMatch(adapter, portInfo, isWindows, conflictProne) {
    let bestMatch;
    ...
    try {
        ...
        for (const portInfo of portList) {
            ...
            const bestMatch = isWindows
                ? undefined
                : findUsbAdapterBestMatch(undefined, portInfo, isWindows, USB_FINGERPRINTS_CONFLICT_IDS.includes(`${portInfo.vendorId}:${portInfo.productId}`));
