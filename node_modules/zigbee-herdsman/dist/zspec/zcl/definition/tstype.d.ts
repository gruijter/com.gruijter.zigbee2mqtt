...
export interface ParameterDefinition extends Parameter {
    conditions?: ({
        ...
        type: ParameterCondition.DATA_TYPE_CLASS_EQUAL;
        value: DataTypeClass;
    } | {
