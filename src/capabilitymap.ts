...
const capabilityMap: { [key: string]: CapabilityMapEntry } = {
  ...
  brightness_11: ['dim', (v) => Number(v) / 254, (v) => ({ brightness_11: Number(v) * 254 })],
  ...
  color_temp_11: ['light_temperature', (v) => (Number(v) - 153) / 347, (v) => ({ color_temp_11: 153 + Number(v) * 347 })],
  color: (expose) => ({
  ...
  state_11: ['onoff', (v) => v === 'ON', (v) => ({ state_11: v ? 'ON' : 'OFF' })],
  ...
  power_on_behavior_11: ['power_on_behavior', (v) => v, (v) => ({ power_on_behavior_11: v })], // [off, on, toggle, previous]
  ...
  effect_11: ['effect', (v) => v, (v) => ({ effect_11: v })], // [blink, breathe, okay, channel_change, finish_effect, stop_effect]
