...
const capabilityMap: { [key: string]: CapabilityMapEntry } = {
  ...
  mmwave_area1_occupancy: ['alarm_occupancy.area1', (v) => v],
  mmwave_area2_occupancy: ['alarm_occupancy.area2', (v) => v],
  mmwave_area3_occupancy: ['alarm_occupancy.area3', (v) => v],
  mmwave_area4_occupancy: ['alarm_occupancy.area4', (v) => v],
